...
if [[ $tests == *"ecn_bulk"* ]]; then
    ...
    for cc_name in dctcp bbr2_min_2 bbr; do
...
set output '$OUTPNG'"
	...
	plot '$outdir/ecn_bulk.dctcp'       u 1:2 t 'dctcp'           w lp lw 2 pt 7 lt rgb \"#d7191c\",\
	     ...
	     '$outdir/ecn_bulk.bbr2_min_2'  u 1:2 t 'bbr2' w lp lw 2 pt 7 lt rgb \"#2c7bb6\"\
...
set output '$OUTPNG'"
	...
	plot '$outdir/ecn_bulk.retrans.dctcp'       u 1:2 t 'dctcp' axis x1y1 w lp lw 2 pt 7 lt rgb \"#d7191c\",\
	     ...
	     '$outdir/ecn_bulk.retrans.bbr2_min_2'  u 1:2 t 'bbr2'  axis x1y1 w lp lw 2 pt 7 lt rgb \"#2c7bb6\"\
